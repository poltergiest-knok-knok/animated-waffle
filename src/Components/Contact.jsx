            ...
            <ContentContainer>
                ...
                <CardsGrid>
                    ...
                    <ContactCard>
                        ...
                        <LinkButton href="https://wa.me/919546628794" target="_blank" rel="noopener noreferrer">
                            Chat Now
                        </LinkButton>
                    </ContactCard>
                    ...
                    <ContactCard>
                        <div>
                            ...
                            <Value style={{ color: '#007AFF', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                ...
                                {showEmail ? (
                                    <a
                                        href="mailto:roshankishorekka@icloud.com"
                                        style={{ color: 'inherit', textDecoration: 'none' }}
                                    >
                                        roshankishorekka@icloud.com
                                    </a>
                                ) : "Email"}
                            </Value>
                        </div>
                        {showEmail ? (
                            <LinkButton as="button" onClick={() => setShowEmail(false)} style={{ cursor: 'pointer' }}>
                                Hide Email
                            </LinkButton>
                        ) : (
                            <LinkButton as="button" onClick={() => setShowEmail(true)} style={{ cursor: 'pointer' }}>
                                Show Email
                            </LinkButton>
                        )}
                    </ContactCard>
                ...
                <SocialSection>
                    ...
                    <SocialDock>
                        ...
                        {/* Abhishek Instagram */}
                        <SocialLink
                            href="https://www.instagram.com/baskeabhishek"
                            target="_blank"
                            rel="noopener noreferrer"
                            $color="rgba(225, 48, 108, 0.4)"
                        >
                        ...
                        {/* Abhishek GitHub */}
                        <SocialLink
                            href="https://github.com/abhishekbaske"
                            target="_blank"
                            rel="noopener noreferrer"
                            $color="rgba(255, 255, 255, 0.2)"
                        >
                        ...
                        {/* Roshan GitHub */}
                        <SocialLink
                            href="https://github.com/roshankishorekka/"
                            target="_blank"
                            rel="noopener noreferrer"
                            $color="rgba(255, 255, 255, 0.2)"
                        >
